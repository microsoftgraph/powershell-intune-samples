...
Write-Host " + Device MDATP Notifications Policy created as" $CreateResult_Notifications.id
...
Write-Host " + Device MDATP Kext Policy created as" $CreateResult_kext.id
...
Write-Host " + Device MDATP Full Disk Access Policy created as" $CreateResult_FullDiskAccess.id
